    ...
    return (
        <>
            <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50 ${sticky
                ? "sticky-navbar dark:bg-slate-800 duration-100 dark:text-white shadow-md bg-base-200 duration-100  duration-300 transition-all ease-in-out " : ""
                }`}>
                <div className="navbar">
                    <div className="navbar-start">
                        <div className="dropdown">
                            ...
                            <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 dark:bg-slate-900 dark:text-white">{navItem}</ul>
                        </div>
                    ...
                    <div className='navbar-end space-x-3'>
                        ...
                        <div className='hidden md:block'>
                            <label className="px-3 py-2 rounded-md border flex items-center gap-2">
                                <input type="text"
                                    className={`grow outline-none dark:bg-slate-900 dark:text-white ${sticky
                                        ? "sticky-navbar dark:bg-slate-800 duration-100 dark:text-white bg-base-200 duration-100  duration-300 transition-all ease-in-out " : ""
                                        }`} placeholder="Search" />
                        ...
                        {authUser ? (<Logout />) : (
                            <div className="">
                                <a className="bg-black px-3 py-2 cursor-pointer rounded-md text-white hover:bg-slate-800 duration-300" onClick={() => (
